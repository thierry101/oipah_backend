    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acceptTerms', models.BooleanField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'is_used'], name='authenticat_user_id_49a6f3_idx'), models.Index(fields=['expired_at'], name='authenticat_expired_311324_idx')],
            },
        ),
        migrations.CreateModel(
            name='Permission',
            fields=[
                ...
                ('permission_type', models.JSONField(blank=True, null=True)),
